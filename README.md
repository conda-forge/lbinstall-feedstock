...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lbinstall-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10582&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lbinstall-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lbinstall` can be installed with:

```
conda install lbinstall
```

It is possible to list all of the versions of `lbinstall` available on your platform with:
